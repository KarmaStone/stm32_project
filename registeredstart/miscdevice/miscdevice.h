...
* @}
*/
extern DEV_HAND c_open(char *name, int32_t flag);
extern int c_read(DEV_HAND fd, uint8_t *data, uint32_t count);
extern int c_write(DEV_HAND fd, uint8_t *data, uint32_t count);
extern int c_ioctl(FIL_HAND *fd, void *buf, uint32_t count, uint32_t flag);
